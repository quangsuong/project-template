...
# 🔥 **quangsuong's GitHub Project Template**

<p align="center">
  <a href="https://github.com/quangsuong/project-template/generate">
    <img width="100%" src="https://i.imgur.com/SVvgxJF.png" alt="@quangsuong/project-template's">
  </a>
  <br>
  <a href="https://github.com/quangsuong/project-template/issues">
    <img src="https://img.shields.io/github/issues/quangsuong/project-template?color=0088ff&style=for-the-badge&logo=github" alt="@quangsuong/project-template's issues"/>
  </a>
  <a href="https://github.com/quangsuong/project-template/pulls">
    <img src="https://img.shields.io/github/issues-pr/quangsuong/project-template?color=0088ff&style=for-the-badge&logo=github" alt="@quangsuong/project-template's pull requests"/>
  </a>
  <a href="https://github.com/quangsuong/project-template/generate">
    <img src="https://img.shields.io/badge/use%20this-template-blue?logo=github-sponsors&style=for-the-badge&color=green" alt="@quangsuong/project-template link to create a new repository from the template">
  </a>
  <a href="https://github.com/quangsuong/project-template/actions/workflows/shelltest.yml">
    <img src="https://github.com/quangsuong/project-template/actions/workflows/shelltest.yml/badge.svg" alt="@quangsuong/project-template's tests">
  </a>
</p>
...
* To start using it; "**[click use this template](https://github.com/quangsuong/project-template/generate)**" and create your new repository,
...
1. To create a new repository from this template, **[generate your new repository from this template](https://github.com/quangsuong/project-template/generate)**;
...
2. Install the [🤖 used GitHub bots](https://github.com/quangsuong/project-template#-used-github-bots) (recommended)
3. Clone your new repository **[generated from this template](https://github.com/quangsuong/project-template/generate)** and `cd` into it.
...
* After **[generating your new repo with this template](https://github.com/quangsuong/project-template/generate)**, make sure to, right after you clone it, run the script `SETUP_TEMPLATE.sh`.
...
<p align="center">
  ...
  Or watch [this video](https://gifs.com/gif/quangsuong-s-readme-md-MwO5E3) to see the whole README template.
</p>
...
For the proper maintenance of the CHANGELOG.md, we recommend this [VSCode extension](https://github.com/quangsuong/Changelog-and-Markdown-snippets)
and the read and understanding of the [keep a changelog guide](https://keepachangelog.com/en/1.0.0/).
Please read and comment about it in this [dev.to post](https://dev.to/quangsuong/the-ultimate-github-project-template-1264).
We also recommend installing all the [used bots](https://github.com/quangsuong/project-template#-used-github-bots).
...
<a href="https://github.com/quangsuong/project-template/generate">
  <img alt="@quangsuong/project-template's brand logo without text" align="right" src="https://i.imgur.com/3qK1sie.png" width="18%" />
</a>
...
<a href="https://github.com/sponsors/quangsuong">
  <img alt="project logo" src="https://img.shields.io/badge/Sponsor-quangsuong/project template-blue?logo=github-sponsors&style=for-the-badge&color=red">
</a>
...
[![GitHub's followers](https://img.shields.io/github/followers/quangsuong.svg?style=social)](https://github.com/quangsuong)
[![GitHub stars](https://img.shields.io/github/stars/quangsuong/project-template.svg?style=social)](https://github.com/quangsuong/project-template/stargazers)
[![GitHub watchers](https://img.shields.io/github/watchers/quangsuong/project-template.svg?style=social)](https://github.com/quangsuong/project-template/watchers)
[![GitHub forks](https://img.shields.io/github/forks/quangsuong/project-template.svg?style=social)](https://github.com/quangsuong/project-template/network/members)

Enjoy! 😃

> ⚠️ Remember that this template should be reviewed and modified to fit your requirements.
> The script **SETUP_TEMPLATE.sh** should be executed right when you clone your new repository generated from [here](https://github.com/quangsuong/project-template/generate).
> There will be files that will need *manual revision* ⚠️

_Made with a lot of ❤️❤️ by **[@quangsuong](https://github.com/quangsuong)**_
